...
export default function DepositPage() {
  ...
  const status = useInvoiceStatus(activeInvoice?.db_id ?? null, !!activeInvoice);
  ...
  const handleCreate = async () => {
    ...
    try {
      const invoice: InvoiceDto = await createInvoice.mutateAsync(value);
      haptic("success");
      ...
      setActiveInvoice({
        db_id: Number(invoice.invoice_id),
