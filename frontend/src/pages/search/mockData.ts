...
export const MOCK_SERVICES: ServiceDto[] = [
  { id: 981, title: "Продажа готового Telegram канала (15к саб)", description: "Канал с живой аудиторией, тематика IT/Бизнес. Чистый доход от рекламы в месяц около 200$. Передача прав полностью через официального гаранта бота.", price: 450, currency: "USD", status: "active", owner_username: "social_seller", category: { id: 901, name: "Социальные сети", slug: "social", icon_key: "more-horizontal", services_count: 24 } },
  { id: 982, title: "Быстрый обмен USDT на рубли (СБП/Тинькофф)", description: "Обмениваю чистый USDT TRC20 на рубли. Минималка от 100$. Чистые резервы. Время проведения сделки в среднем 5 минут.", price: 100, currency: "USD", status: "active", owner_username: "swift_change", category: { id: 902, name: "Криптовалюта", slug: "crypto", icon_key: "bitcoin", services_count: 42 } },
  { id: 983, title: "Разработка Telegram Mini App под ключ", description: "Качественная разработка мини-приложений (TMA) любой сложности. Стек: React/TypeScript/FastAPI. Сроки от 7 дней.", price: 800, currency: "USD", status: "active", owner_username: "tma_dev", category: { id: 903, name: "Разработка ботов", slug: "bots", icon_key: "key", services_count: 18 } },
  { id: 984, title: "Дизайн аватарок и баннеров для каналов", description: "Оформление вашего Telegram канала, создание уникальных аватарок, баннеров и обложек для постов в едином стиле.", price: 50, currency: "USD", status: "active", owner_username: "pixel_pro", category: { id: 905, name: "UI/UX Дизайн", slug: "design", icon_key: "palette", services_count: 12 } },
];
