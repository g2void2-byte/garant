...
HELP_DESCRIPTION = (
    "⁉️ Нажмите кнопку «Открыть FAQ», чтобы запустить Mini App и "
    "посмотреть ответы на основные вопросы: правила гаранта, оплаты, "
    "выплаты, арбитраж, что делать в спорных ситуациях."
)
